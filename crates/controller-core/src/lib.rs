...
#[openapi(
    ...
    components(
        schemas(
            ...
            opentalk_types::common::event::CallIn,
            opentalk_types::common::event::EventInfo,
            opentalk_types::common::event::MeetingDetails,
            opentalk_types::common::event::StreamingLink,
