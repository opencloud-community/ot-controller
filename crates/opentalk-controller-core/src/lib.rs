        ...
        loop {
            tokio::select! {
                ...
                _ = reload_signal.recv() => {
                    ...
                    if let Err(e) = self.settings_provider.reload_from_path(&self.args.config) {
...
#[openapi(
    ...
    components(
        schemas(
            ...
            opentalk_types_api_v1::turn::GetTurnResponseBody,
            opentalk_types_api_v1::turn::IceServer,
            opentalk_types_api_v1::turn::StunServer,
            opentalk_types_api_v1::turn::TurnServer,
